...
The resource for [IBM Design Language](https://www.ibm.com/design/language/)'s [color library](https://www.ibm.com/design/language/resources/color-library/) in .ase, .clr, .json, .scss, and .sketchpalette extensions. Read our [Color Guidelines](https://www.ibm.com/design/language/experience/visual/color/) to learn how to best use these colors.
